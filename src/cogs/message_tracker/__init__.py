"""Ког message_tracker: пишет метаданные каждого сообщения (автор, канал, дата) в БД
для подсчёта активности. Содержимое не сохраняется. Трекаются все сообщения гильдии."""
